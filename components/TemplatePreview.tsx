...
export function TemplatePreview({ data, className }: TemplatePreviewProps) {
  ...
  const renderTemplate = () => {
    switch (theme.template) {
      case 'minimalist':
        return <MinimalistTemplate data={data} isDark={isDark} />;
      case 'modern':
      ...
      case 'executive':
        return <ExecutiveTemplate data={data} isDark={isDark} />;
      default:
        return <ModernTemplate data={data} isDark={isDark} />;
    }
  };
...
function MinimalistTemplate({ data, isDark }: { data: ResumeData; isDark: boolean }) {
...
function ModernTemplate({ data, isDark }: { data: ResumeData; isDark: boolean }) {
  const { personalInfo, experiences, education, skills, projects } = data;
...
function CreativeTemplate({ data, isDark }: { data: ResumeData; isDark: boolean }) {
  const { personalInfo, experiences, education, skills, projects } = data;
...
function ProfessionalTemplate({ data, isDark }: { data: ResumeData; isDark: boolean }) {
  const { personalInfo, experiences, education, skills, projects } = data;
...
function ExecutiveTemplate({ data, isDark }: { data: ResumeData; isDark: boolean }) {
  const { personalInfo, experiences, education, skills, projects } = data;
